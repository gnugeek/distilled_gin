...
== Usage
  ...
  class AddGin < ActiveRecord::Migration
    def self.up
      add_gin_index :model => :model_name, :columns => [:col1, :col2, :col3]
    end
 
    def self.down 
      remove_gin_index :model => 'model_name
    end 
  end
...
* Migration commands for full text search configuration ( see http://www.postgresql.org/docs/8.3/static/textsearch-configuration.html )
